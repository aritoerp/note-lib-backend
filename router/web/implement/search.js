...
module.exports = async (req, res) => {
    try {
        ...
        let config = {
            ...
            url: `${process.env.API_HOST}/List/SearchBook`,
            headers: {
        ...
        let contents = Array.isArray(response.data?.data?.data) ? response.data.data.data : [];
        return res.json({
            "code": 200,
            "messageCode": "",
            "messageText": "Lấy danh sách tìm kiếm thành công",
            "data": contents
        });
    } catch (e) {
